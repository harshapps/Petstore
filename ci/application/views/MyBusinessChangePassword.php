    <?php
        ...
        if(isset($_POST['email']) and isset($_POST['oldpassword']) and isset($_POST['newpassword']) and isset($_POST['confirmnewpassword'])){
            ...
            if(trim($_POST['newpassword']) != trim($_POST['confirmnewpassword'])){
                ...
                echo "<script>location.href = 'MyBusinessChangePassword.php';</script>";
                exit;
            }else{
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="leftVerticalPane"  class="myBusinessChangePasswordNav">
                <nav>
                    <ul>
            ...
            <div id="rightVerticalPane" class="myBusinessChangePasswordRightVerNav">
                <section>
                    <article>
